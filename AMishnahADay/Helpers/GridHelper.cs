...
namespace AMishnahADay.Helpers;
...
public class GridHelper {
  ...
  public static string GetGridRows(Grid theGrid) => Convert.ToString(theGrid.GetValue(GridRowsProperty));

  public static void SetGridRows(Grid theGrid, string value) => theGrid.SetValue(GridRowsProperty, value);

  private static void GridRowsPropertyChanged(object sender, DependencyPropertyChangedEventArgs e) {
    if (sender is not Grid This) {
  ...
  public static string GetGridCols(Grid theGrid) => Convert.ToString(theGrid.GetValue(GridColsProperty));

  public static void SetGridCols(Grid theGrid, string value) => theGrid.SetValue(GridColsProperty, value);
  ...
  private static bool IsFloat(string s) => float.TryParse(s, out float n);
